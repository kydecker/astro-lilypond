...
- e87590e: Adds an `includePaths` config option to extend `\include` resolution with extra directories, in addition to each score's own directory.
...
- 06ff6cc: **Announcing Astro Lilypond 1.0!**
