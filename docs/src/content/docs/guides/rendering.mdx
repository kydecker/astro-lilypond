...
When you have larger scores that are too large to write directly in [Markdown](/guides/markdown), you can use the `render()` function to have greater control over output.
