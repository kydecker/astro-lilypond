...
`loading` hint forwarded onto every rendered `<img>`. For more info, see [MDN](https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/loading).
...
`decoding` hint forwarded onto every rendered `<img>`. For more info, see [MDN](https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/decoding).

### `fetchpriority`

**Type:** `"high" | "low" | "auto"`

`fetchpriority` hint forwarded onto every rendered `<img>`. For more info, see [MDN](https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/fetchPriority).
