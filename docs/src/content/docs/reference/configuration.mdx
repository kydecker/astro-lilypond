...
Rendered scores are cached and served via [`astro-emit-asset`](https://github.com/delucis/astro-emit-asset); unchanged scores are reused across builds instead of being re-rendered, with no configuration needed.
